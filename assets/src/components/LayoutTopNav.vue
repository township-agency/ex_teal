<template>
  <header class="relative flex items-center h-16 border-b border-gray bg-gray-lightest px-4 sm:px-6 md:px-8">
    <button
      class="hover:bg-gray-lightest lg:hidden flex-grow-0 mr-4 z-10"
      @click="openSideNav"
    >
      <icon type="menu" />
    </button>
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <span class="text-gray-darkest"> {{ config.currentUser.name }} </span>
          </dropdown-trigger>
